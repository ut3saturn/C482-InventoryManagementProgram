...
public class ModifyPartController implements Initializable {
    ...
    public void initData(Part part, Inventory inv) {
        ...
        partIDTF.setText(Integer.toString(selectedPart.getPartID()));
        partNameTF.setText(part.getPartName());
        partCostTF.setText(Double.toString(part.getPartCost()));
        partStockTF.setText(Integer.toString(part.getPartStock()));
        partMaxStockTF.setText(Integer.toString(part.getPartMaxStock()));
        partMinStockTF.setText(Integer.toString(part.getPartMinStock()));
